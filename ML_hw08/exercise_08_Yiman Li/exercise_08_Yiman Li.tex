...
\makeatother
    ...
    \hypertarget{programming-assignment-4-svm}{%
\section{Programming assignment 4:
SVM}\label{programming-assignment-4-svm}}
...
\subsection{Your task}\label{your-task}}
    ...
    In this sheet we will implement a simple binary SVM classifier. Your
task is to complete the functions where required. You are only allowed
to use built-in Python functions, as well as any \texttt{numpy}
functions. No other libraries / imports are allowed.

To solve optimization tasks we will use \textbf{\texttt{CVXOPT}}
http://cvxopt.org/ - a Python library for convex optimization. If you
use \texttt{Anaconda}, you can install it using
...
\PY{n}{seed} \PY{o}{=} \PY{l+m+mi}{1234}  \PY{c+c1}{\PYZsh{} for reproducible experiments}

\PY{n}{X}\PY{p}{,} \PY{n}{y} \PY{o}{=} \PY{n}{make\PYZus{}blobs}\PY{p}{(}\PY{n}{n\PYZus{}samples}\PY{o}{=}\PY{n}{N}\PY{p}{,} \PY{n}{n\PYZus{}features}\PY{o}{=}\PY{n}{D}\PY{p}{,} \PY{n}{centers}\PY{o}{=}\PY{n}{C}\PY{p}{,} \PY{n}{random\PYZus{}state}\PY{o}{=}\PY{n}{seed}\PY{p}{)}
...
\textbf{Your task} is to formulate the SVM dual problems as a QP of this
form and solve it using \texttt{CVXOPT}, i.e.~specify the matrices
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{solve\PYZus{}dual\PYZus{}svm}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{y}\PY{p}{)}\PY{p}{:}
...
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    ...
    \PY{n}{samples} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{shape}\PY{p}{(}\PY{n}{X}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
    \PY{n}{y\PYZus{}Mat} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{mat}\PY{p}{(}\PY{n}{y}\PY{p}{)}
    \PY{n}{P} \PY{o}{=} \PY{n}{matrix}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{multiply}\PY{p}{(}\PY{n}{X}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{X}\PY{o}{.}\PY{n}{T}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{n}{y\PYZus{}Mat}\PY{o}{.}\PY{n}{T}\PY{p}{)}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{y\PYZus{}Mat}\PY{p}{)}\PY{p}{)}\PY{p}{)}
    \PY{n}{q} \PY{o}{=} \PY{n}{matrix}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{l+m+mf}{1.0}\PY{p}{,} \PY{p}{(}\PY{n}{samples}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}
    \PY{n}{G} \PY{o}{=} \PY{n}{matrix}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{n}{np}\PY{o}{.}\PY{n}{identity}\PY{p}{(}\PY{n}{samples}\PY{p}{)}\PY{o}{.}\PY{n}{astype}\PY{p}{(}\PY{n+nb}{float}\PY{p}{)}\PY{p}{)}
    \PY{n}{h} \PY{o}{=} \PY{n}{matrix}\PY{p}{(}\PY{l+m+mf}{0.0}\PY{p}{,} \PY{p}{(}\PY{n}{samples}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}
    \PY{n}{A} \PY{o}{=} \PY{n}{matrix}\PY{p}{(}\PY{n}{y}\PY{o}{.}\PY{n}{astype}\PY{p}{(}\PY{n+nb}{float}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{samples}\PY{p}{)}\PY{p}{)}
    \PY{n}{b} \PY{o}{=} \PY{n}{matrix}\PY{p}{(}\PY{l+m+mf}{0.0}\PY{p}{,} \PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}
    ...
    \PY{k}{return} \PY{n}{alphas}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{compute\PYZus{}weights\PYZus{}and\PYZus{}bias}\PY{p}{(}\PY{n}{alpha}\PY{p}{,} \PY{n}{X}\PY{p}{,} \PY{n}{y}\PY{p}{)}\PY{p}{:}
...
\PY{l+s+sd}{        Bias term.}
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    \PY{n}{alpha\PYZus{}y} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{multiply}\PY{p}{(}\PY{n}{alpha}\PY{p}{,} \PY{n}{y}\PY{p}{)}
    \PY{n}{w} \PY{o}{=} \PY{p}{(}\PY{n}{X}\PY{o}{.}\PY{n}{T}\PY{p}{)}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{alpha\PYZus{}y}\PY{p}{)}
    \PY{n}{b} \PY{o}{=} \PY{l+m+mi}{0}
    \PY{n}{index} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{alpha}\PY{p}{)}\PY{p}{)}\PY{p}{[}\PY{p}{(}\PY{n}{alpha} \PY{o}{\PYZgt{}} \PY{l+m+mf}{1e\PYZhy{}4}\PY{p}{)}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{]}
    \PY{c+c1}{\PYZsh{}b = np.sum(np.multiply(y \PYZhy{} X.dot(w), alpha)) / np.sum(alpha) / np.shape(X)[0] \PYZsh{} not all data are valid, use support vector only!}
    \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{)}\PY{p}{:}
        \PY{n}{b} \PY{o}{+}\PY{o}{=} \PY{p}{(}\PY{n}{y} \PY{o}{\PYZhy{}} \PY{n}{X}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{w}\PY{p}{)}\PY{p}{)}\PY{p}{[}\PY{n}{index}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{]}
    \PY{n}{b} \PY{o}{/}\PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{shape}\PY{p}{(}\PY{n}{index}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{plot\PYZus{}data\PYZus{}with\PYZus{}hyperplane\PYZus{}and\PYZus{}support\PYZus{}vectors}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{y}\PY{p}{,} \PY{n}{alpha}\PY{p}{,} \PY{n}{w}\PY{p}{,} \PY{n}{b}\PY{p}{)}\PY{p}{:}
...
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    ...
    \PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{x} \PY{o}{*} \PY{n}{slope} \PY{o}{+} \PY{n}{intercept} \PY{o}{\PYZhy{}} \PY{l+m+mi}{1}\PY{o}{/}\PY{n}{w}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{k\PYZhy{}\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    \PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{x} \PY{o}{*} \PY{n}{slope} \PY{o}{+} \PY{n}{intercept} \PY{o}{+} \PY{l+m+mi}{1}\PY{o}{/}\PY{n}{w}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{k\PYZhy{}\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{alpha} \PY{o}{=} \PY{n}{solve\PYZus{}dual\PYZus{}svm}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{y}\PY{p}{)}
...
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{support vectors:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{alpha}\PY{p}{)}\PY{p}{)}\PY{p}{[}\PY{p}{(}\PY{n}{alpha} \PY{o}{\PYZgt{}} \PY{l+m+mf}{1e\PYZhy{}4}\PY{p}{)}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{]}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}

    \begin{Verbatim}[commandchars=\\\{\}]
w = [0.73935606 0.41780426]
b = 0.9199371454171282
